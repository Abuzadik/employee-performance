	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-success btn-flat border-primary" href="./index.php?page=new_evaluator"><i class="fa fa-plus"></i> Add New Evaluator</a>
			</div>
		</div>
		<div class="card-body able-responsive">
			<table class="table tabe-hover table-bordered table-info " id="list">
				<thead>
					<tr>
